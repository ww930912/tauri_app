...
import { QuestionCircleOutlined, PlaySquareOutlined, GithubFilled, EyeOutlined, DownloadOutlined, CloudDownloadOutlined, CloseCircleFilled } from "@ant-design/icons";
          ...
          onClick={async () => {
            ...
            try {
              if (parseType === "video") {
                ...
                const { video_count, uid } = await invoke("get_user_info_by_url", { addr: url, }) as unknown as any;
                const info = await invoke("get_list_by_user_id", { uid, count: video_count, maxCursor: 0 }) as unknown as any;
      ...
      {videoInfo?.length > 0 ? (
        ...
        <div className="App-logo">
          ...
          <Button
            ...
            size="large"
            onClick={() =>
              open_url("https://github.com/ww930912/tauri_app")
            }
          >
            <b> Star</b>
          </Button>
